...
oks = []
id = []
print 'AUTHOR : Hunter277'
print 'FACEBOOK :Hunter277'
print 'GITHUB : Hunter277'
CorrectUsername = 'Hunter2022'
CorrectPassword = 'Hunter2022'
loop = 'true'
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://go.fiverr.com/visit/?bta=315883&brand=fiverrcpa')
    else:
